 ...
 * @ctrl26_offset: offset to F12_2D_CTRL26 register
 */
...
struct synaptics_rmi4_data {
	...
	struct mutex rmi4_drvdata_mutex;
	bool zenMotion_dclick;
	u8 zenMotion_gesture;
	bool zenMotion_swipeup;

	bool enable_gloved;

	bool auto_update_finish;
};
