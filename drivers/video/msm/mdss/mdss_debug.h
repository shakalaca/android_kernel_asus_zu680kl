...
#define ATRACE_END(name) trace_tracing_mark_write(current->tgid, name, 'E', 0)
#define ATRACE_BEGIN(name) trace_tracing_mark_write(current->tgid, name, 'B', 0)
#else
...
#define ATRACE_INT(name, value) \
	trace_tracing_mark_write(current->tgid, name, 'C', value)
#else
#define ATRACE_INT(name, value) \
