...
typedef struct vfsspi_ioc_select_drdy_notify_type {
	unsigned int supported_type;
	unsigned int selected_type;
} vfsspi_ioc_select_drdy_notify_type_t;
