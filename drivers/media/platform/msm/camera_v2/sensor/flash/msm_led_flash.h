...
struct msm_flash_fn_t {
	...
	int32_t (*flash_led0)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led1)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led01)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led2)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led0_flash)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led1_flash)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led01_flash)(struct msm_led_flash_ctrl_t *);
	int32_t (*flash_led2_flash)(struct msm_led_flash_ctrl_t *);
//	void (*flash_led_set_current)(unsigned int, unsigned int*, unsigned int);
	const int (*custom_flash_command)(struct msm_camera_i2c_reg_array * const dest_array, const bsp_flash_data config, const unsigned int size);
...
struct msm_led_flash_reg_t {
	...
	struct msm_camera_i2c_reg_setting *led0_setting;
	struct msm_camera_i2c_reg_setting *led1_setting;
	struct msm_camera_i2c_reg_setting *led01_setting;
	struct msm_camera_i2c_reg_setting *led2_setting;
	struct msm_camera_i2c_reg_setting *led0_flash_setting;
	struct msm_camera_i2c_reg_setting *led1_flash_setting;
	struct msm_camera_i2c_reg_setting *led01_flash_setting;
	struct msm_camera_i2c_reg_setting *led2_flash_setting;
...
//void flash_led_set_current(unsigned int, unsigned int*, unsigned int);
const int msm_flash_led_data_to_i2c(struct msm_camera_i2c_reg_array * const dest_array, const bsp_flash_data config, const unsigned int size);
