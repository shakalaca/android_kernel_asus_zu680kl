...
static int set_reverse_charger_mode(char *str)
{
    ...
    {
        g_reverse_charger_mode = 1;
    }
    else
    {
        g_reverse_charger_mode = 0;
    }
    printk("androidboot.reverse.mode charger is %d\n",  g_reverse_charger_mode);
    return 0;
}
__setup("androidboot.reverse.mode=", set_reverse_charger_mode);

int g_charger_mode = 0;
...
static int set_charger_mode(char *str)
{
    ...
    printk("androidboot.mode charger is %d\n",  g_charger_mode);
    return 0;
}
 ...
 */
	...
	entry_mode = 1;
	loc_reco = strstr(boot_command_line,"androidboot.iris.mode=recovery");
	if (loc_reco != NULL) {
		entry_mode = 2;
		printk(KERN_NOTICE "string match androidboot.iris.mode=recovery.\n");
	}
