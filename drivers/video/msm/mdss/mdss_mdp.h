...
void mdss_dsi_video_mode_conf(struct mdss_panel_data *pdata,
		u32 h_start, u32 h_end, u32 h_total, u32 h_spw,
		u32 v_start, u32 v_end, u32 v_total, u32 v_spw);
#endif
...
int mdss_mdp_display_wakeup_time(struct mdss_mdp_ctl *ctl,
				ktime_t *wakeup_time, u32 *time_to_end_of_vbl_ns);
#else
int mdss_mdp_display_wakeup_time(struct mdss_mdp_ctl *ctl,
				 ktime_t *wakeup_time);
#endif
